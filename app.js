...
const PropertyManagement = () => {
  ...
  useEffect(() => {
    ...
    space.addDataLayer({
      ...
      onClick: (d) => {
        console.log('Clicked report ID:', d.id);
        const clickedReport = reports.find(report => report.id === d.id);
        console.log('Clicked report data:', clickedReport);
        setModalId(d.id);
  ...
  <Modal
    opened
    onClose={() => {
      console.log('Closing modal. State before:', modalId);
      setModalId(null);
    }}
